...
export default function Contact() {
  return (
    <section>
      ...
      <div className="relative z-10 rounded-md shadow-md bg-[#ebebeb] dark:bg-gray-600 p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
          ...
          <div className="md:ml-4">
            ...
            <div className="social-icons flex flex-row space-x-8">
              <a
                ...
                className="h-10 w-10 rounded-full hover:bg-gray-300 dark:bg-gray-500 flex items-center justify-center cursor-pointer"
              >
                <svg
                  width="24"
                  height="24"
