  ...
  return (
    <section className="max-w-5xl  mx-auto px-4 bg-white dark:bg-gray-800">
      <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800">
        <h1 className=" text-2xl md:text-4xl font-bold pt-10 px-5 text-left md:text-left">
          About Me.
        </h1>
      </div>
      <div>
      ...
      <div className="bg-[#ebebeb] dark:bg-gray-900 px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 py-10 max-w-6xl mx-auto gap-y-20 gap-x-20">
          {/* Social Buttons */}
          <div className="inline-flex flex-col">
            <div>
              ...
              <p className="text-base text-gray-500 mt-4 dark:text-gray-300">
            ...
            {/* Social Links */}
            <h1 className="text-lg font-semibold text-gray-700 mt-8 dark:text-gray-200">
              Social Links
            </h1>
            <div className="mt-4 ml-4">
              <div className="flex flex-row justify-start items-center ">
                ...
                >
                  <div className="my-1">&rarr;</div>
                  <p className="text-base text-gray-500 font-mono relative overflow-hidden dark:text-gray-300">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <h1 className="bg-gray-500 text-xl rounded-md px-2 py-1 inline-block font-bold text-gray-50">
              Tech Stack
            </h1>
